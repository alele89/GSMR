...
public class TrainA {
	private static class SBStatus { 
        ...
        String route="";//new
        String route1="";//new
        int flag = 0;//0=No similarities,1=similarities
        String id = "7";
	...
	public static void main(String args[])
	{
		...
		if (em != null)
		{
			...
			MessageWindow mw = new MessageWindow("Train A Console", WinPosX, WinPosY);
	    	...
	    	mw.WriteMessage("Train A is in the network 'A123'." );
	    	SBStatus s = new SBStatus();
	    	s.Status = true;
	    	s.a = 1;
	    	System.out.println("Enter train Configurations");
	...
	private static class Task implements Runnable{
        ...
        String msg1="Train A enters the rail network segment 'A123'";
        String msg2="Permission to take control of the swicth board";
        String msg3="Train A has relinquished control and has left the network";
        EventQueue eq = null;
        Event Evt = null;
        ...
        while(!Done1)
        {
        	...
        	if(s1.a == 1)
        	{
        		PostTrainStatus(em2,msg1,5);
        		PostTrainStatus(em2,s1.route,65);
        	}
        	if(s1.a == 2)
        	{
        		PostTrainStatus(em2,msg2,10);
        	}
        	if(s1.a == 3)
        	{
        		PostTrainStatus(em2,msg3,30);
        		PostTrainStatus(em2,s1.id,70);
	...
	private static class Task1 implements Runnable{
        ...
        MessageWindow mw2 = new MessageWindow("Train A Speed Monitor", WinPosX, WinPosY);
